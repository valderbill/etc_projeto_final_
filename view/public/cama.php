...
$produtos = $produtoDAO->getProdutosByCategoria('cama'); 
        ...
        <?php if (count($produtos) > 0): ?>
            <?php foreach ($produtos as $produto): ?>
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="../img/cama/<?php echo htmlspecialchars($produto['imagem']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($produto['nomeProd']); ?>">
                        <div class="card-body">
